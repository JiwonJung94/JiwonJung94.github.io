...
def render_book(book_dir: str | Path, out_dir: str | Path, book_id: str | None=None, css: str | None=None, site_title=None, site_url: str | None=None, site_default_locale: str | None=None, views_url: str | None=None, verification=None) -> Book:
